...
REQUIRED_CURRENT_EVIDENCE_REPORTS = (
    ...
    "synthgl_ingest_confidence_sample_100_corpus_buckets",
    ...
    "sec_era_2012_2015_package_only_corpus_buckets",
    "sec_era_2016_2018_package_only_corpus_buckets",
    "sec_era_2019_2022_package_only_corpus_buckets",
    "sec_ria_2006_2011_package_only_corpus_buckets",
    "sec_ria_2012_2015_package_only_corpus_buckets",
    "sec_ria_2016_2018_package_only_corpus_buckets",
    "sec_ria_2019_2022_package_only_corpus_buckets",
    "bls_cps_annual_tables_package_only_corpus_buckets",
    "calamine_reader_corpus_buckets",
    "ilpa_reporting_template_corpus_buckets",
    "wbd_wdesk_corpus_buckets",
    "bf30_remaining_corpus_buckets",
    "blind_holdout_corpus_buckets",
    "rescue_downloads_corpus_buckets",
    "sec_edgar_corpus_buckets",
    "iran_osint_corpus_buckets",
    "powerpivot_variants_corpus_buckets",
    "slicer_timeline_variants_corpus_buckets",
    "excelbench_core_corpus_buckets",
    "excelbench_external_validated_corpus_buckets",
    "excelbench_real_world_manifest_corpus_buckets",
    "spreadsheet_peek_examples_corpus_buckets",
    "ticker_to_gl_strongbox_corpus_buckets",
    "synthgl_docs_examples_corpus_buckets",
    "fintech_hackathon_demo_corpus_buckets",
    "sec_adviser_reports_sample_corpus_buckets",
    "sec_commission_votes_corpus_buckets",
    "sec_enforcement_corpus_buckets",
    "domain_consolidation_corpus_buckets",
    "domain_international_standards_corpus_buckets",
    "fed_asset_pricing_corpus_buckets",
    "fdic_qbp_timeseries_corpus_buckets",
    "domain_ground_truth_valid_corpus_buckets",
    "synthgl_qoe_saas_001_corpus_buckets",
    "codexaudit_qoe_workbooks_corpus_buckets",
    ...
    "public_microsoft_extra_gap_radar",
    "synthgl_real_world_ingestion_gap_radar",
    "synthgl_cds_case_study_gap_radar",
    "synthgl_codex_spark_archive_71_gap_radar",
    "calamine_reader_gap_radar",
    "ilpa_reporting_template_gap_radar",
    "wbd_wdesk_gap_radar",
    "bf30_remaining_gap_radar",
    "blind_holdout_gap_radar",
    "rescue_downloads_gap_radar",
    "sec_edgar_gap_radar",
    "excelbench_core_gap_radar",
    "excelbench_external_validated_gap_radar",
    "excelbench_real_world_manifest_gap_radar",
    "spreadsheet_peek_examples_gap_radar",
    "fintech_hackathon_demo_gap_radar",
    "sec_investment_advisers_gap_radar",
    "sec_commission_votes_gap_radar",
    "sec_enforcement_gap_radar",
    "domain_consolidation_gap_radar",
    "domain_international_standards_gap_radar",
    "fed_asset_pricing_gap_radar",
    "fdic_qbp_timeseries_gap_radar",
    "ticker_to_gl_strongbox_gap_radar",
    "synthgl_docs_examples_gap_radar",
    "domain_ground_truth_valid_gap_radar",
    "fed_aea_papers_gap_radar",
    "synthgl_qoe_saas_001_gap_radar",
    "local_project_holdouts_gap_radar",
    "nemesis_small_example_gl_gap_radar",
    "codexaudit_qoe_workbooks_gap_radar",
    "iran_osint_gap_radar",
    ...
    "sec_commission_votes_quick_mutation_report",
    "sec_enforcement_quick_mutation_report",
    "domain_consolidation_quick_mutation_report",
    "domain_international_standards_quick_mutation_report",
    "fed_asset_pricing_quick_mutation_report",
    "fdic_qbp_timeseries_quick_mutation_report",
    ...
    "synthgl_ingest_confidence_sample_100_gap_radar",
    "synthgl_ingest_confidence_sample_100_quick_mutation_report",
