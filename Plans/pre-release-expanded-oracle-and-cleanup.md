...
|---|---:|---|
| `src/wolfxl/mod.rs` | 3286 | Continue splitting patcher phases and save-path orchestration behind the same PyO3 surface. |
...
12. Next helper candidate: continue with another narrow Rust save phase only if
