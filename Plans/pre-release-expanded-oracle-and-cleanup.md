...
| `python/wolfxl/_worksheet.py` | 2503 | Continue extracting pending-flush helpers and feature-specific collections while preserving openpyxl-shaped imports. |
...
31. Next helper candidate: continue with another narrow Rust save phase only if
