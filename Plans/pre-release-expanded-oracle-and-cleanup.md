...
| `src/native_writer_backend.rs` | 3222 | Split Python-to-writer parsing into cells, formats, tables, charts, drawings, pivots, and sheet setup modules. |
...
55. Next helper candidate: continue with another narrow Rust save phase only if
