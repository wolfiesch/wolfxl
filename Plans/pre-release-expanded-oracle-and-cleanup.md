...
| `python/wolfxl/_worksheet.py` | 1838 | Continue extracting pending-flush helpers and feature-specific collections while preserving openpyxl-shaped imports. |
...
36. Next helper candidate: continue with another narrow Rust save phase only if
