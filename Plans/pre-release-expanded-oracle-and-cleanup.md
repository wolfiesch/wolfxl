...
| `python/wolfxl/_workbook.py` | 2263 | Separate workbook orchestration from feature registration and save pipeline helpers. |
...
26. Next helper candidate: continue with another narrow Rust save phase only if
