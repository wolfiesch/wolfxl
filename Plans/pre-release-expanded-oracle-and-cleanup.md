...
| `src/native_writer_backend.rs` | 2932 | Split Python-to-writer parsing into cells, formats, tables, charts, drawings, pivots, and sheet setup modules. |
...
55. Native writer format, border, and color-normalization payload parsing moved
   ...
   color normalization.
56. Next helper candidate: continue with another narrow Rust save phase only if
