...
| `crates/wolfxl-writer/src/emit/sheet_xml.rs` | 2703 | Split sheet emission into cells, dimensions, merges, hyperlinks, validations, CF, drawings, tables, and page setup. |
...
49. Next helper candidate: continue with another narrow Rust save phase only if
