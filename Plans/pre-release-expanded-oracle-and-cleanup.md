...
| `python/wolfxl/_worksheet.py` | 2593 | Continue extracting pending-flush helpers and feature-specific collections while preserving openpyxl-shaped imports. |
...
29. Worksheet append and bulk-write buffer materialization helpers moved into
   ...
   non-batchable per-cell extraction semantics.
30. Next helper candidate: continue with another narrow Rust save phase only if
