...
| `crates/wolfxl-writer/src/emit/sheet_xml.rs` | 2570 | Split sheet emission into cells, dimensions, merges, hyperlinks, validations, CF, drawings, tables, and page setup. |
...
51. Next helper candidate: continue with another narrow Rust save phase only if
