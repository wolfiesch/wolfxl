...
| `python/wolfxl/_workbook.py` | 2360 | Separate workbook orchestration from feature registration and save pipeline helpers. |
...
25. Next helper candidate: continue with another narrow Rust save phase only if
