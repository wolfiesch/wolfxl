...
| G04 | Protection (sheet/workbook) Python flow-through                     | P1  | ∥ 🟨  | S1     | review      | Codex   | feat/parity-G04-protection | 2026-05-03 |           | WorkbookProtection camelCase aliases ✅ (15 tests pass). Cell.protection setter wired but persistence broken (`locked/hidden` don't round-trip — native_writer_formats lacks Protection emit). Need Claude takeover for cell-half. |
| G05 | NamedStyle / GradientFill / DifferentialStyle flow                  | P1  | ∥ 🧠  | S1     | blocked     | Claude  | feat/parity-G05-named-style-bridge | 2026-05-03 |           | Codex pod returned POD-BLOCKED 03:02 PDT — root cause: `_worksheet_writer_flush.py` and `native_writer_formats.rs` apply format/border as separate style-ID replacements, clobbering attributes. Reclassified 🤖→🧠. |
| G06 | Image replace/delete public API                                     | P1  | ∥ 🤖  | S1     | review      | Codex   | feat/parity-G06-image-replace-remove | 2026-05-03 | 2026-05-03 | Pod returned POD-DONE (b01a447). 528 lines: new `_worksheet_media.py`, `patcher_drawing.rs`. Closes `images.replace_remove` probe. 2286 passed, no regressions. |
| G07 | Array/DataTable/spill formula coverage audit + tests                | P1  | ∥ 🤖  | S1     | review      | Codex   | feat/parity-G07-data-table-formula | 2026-05-03 | 2026-05-03 | Committed 2026-05-03 03:08 PDT (e8b029e). Closes `array_formulas.data_table` probe. Pod returned POD-FAILED on -k filter (handoff used registration name not parametrize ID); work re-verified clean (2285 passed, no regressions). |
