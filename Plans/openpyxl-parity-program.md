...
| G03 | Diagonal borders Python bridge (writer model exists)                | P1  | ∥ 🤖  | S1     | proposed    |         |        |            |           | Exemplar: existing border emit |
| G04 | Protection (sheet/workbook) Python flow-through                     | P1  | ∥ 🤖  | S1     | proposed    |         |        |            |           | Exemplar: existing modify-mode flush |
