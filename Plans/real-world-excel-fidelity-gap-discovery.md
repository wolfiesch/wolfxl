...
1. Keep widening the external workbook corpus sweep with provenance buckets:
   ...
   workbooks. The Calamine reader-corpus sweep is now pinned as side evidence,
   but it is not a clean gate because it includes malformed/encrypted fixtures
   and still lacks PowerPivot plus slicer/timeline coverage.
